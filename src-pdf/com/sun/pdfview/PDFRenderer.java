...
public class PDFRenderer extends BaseWatchable implements Runnable {
    ...
    private static final String TAG = "sun."+PDFRenderer.class.getSimpleName()+"_class";
    private int cmdCnt;
...
//    }
    ...
    public int iterate() throws Exception {
        ...
        if (imageRef != null) {
            ...
            if (bica == null) {
                SavelogPDF.w(TAG, "Image went away.  Stopping");
        ...
        if (!PDFParser.RELEASE) {
            cmdCnt += 1;
            SavelogPDF.i(TAG, "CMD[" + cmdCnt + "]: " + cmd.toString() + ": " + cmd.getDetails());
        }
