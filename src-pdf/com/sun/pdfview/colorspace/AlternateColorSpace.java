...
public class AlternateColorSpace extends PDFColorSpace {
	private static final String TAG = AlternateColorSpace.class.getSimpleName()+"_class";
    ...
    @Override public int toColor(float[] fcomp) {
        ...
        // AHui: quick fix if fcomp has length 1, then return fcomp;
        if (fcomp.length==1) {
        	SavelogPDF.d(TAG, debug, "fcomp size 1 value=" + fcomp);
        	return Color.rgb((int) fcomp[0], (int) fcomp[0], (int) fcomp[0]);
        }
