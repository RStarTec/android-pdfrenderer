...
public class Glyf {
    ...
    public static Glyf getGlyf(ByteBuffer data) {
        ...
        SavelogPDF.d(TAG, debug, "getGlyf() : numContours=" + numContours);
        
        Glyf g = null;
        if (numContours == 0) {
            // no glyph data
            SavelogPDF.e(TAG, "getGlyf() : no data for glyph");
            g = new Glyf();
        ...
        SavelogPDF.d(TAG, debug, "glyph box: (" + g.getMinX() + "," + g.getMaxX() + "," + g.getMinY() + "," + g.getMaxY() + ")");
