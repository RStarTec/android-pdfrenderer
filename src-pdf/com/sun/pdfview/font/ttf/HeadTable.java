...
public class HeadTable extends TrueTypeTable {
	private static final String TAG = HeadTable.class.getSimpleName()+"_class";
    ...
    public void setData(ByteBuffer data) {
    	if (data.remaining() < 54) {
    		// Ahui: Test for < 54 instead of != 54
        	SavelogPDF.e(TAG, "data remaining = " + data.remaining());
        ...
        SavelogPDF.d(TAG, debug, "setData: \n" + toString());
    }
