...
public class LocaTable extends TrueTypeTable {
	private static final String TAG = LocaTable.class.getSimpleName()+"_class";
    ...
    protected LocaTable(TrueTypeFont ttf) {
        ...
        SavelogPDF.d(TAG, debug, "format long : " + isLong);
    ...
    public int getSize(int glyphID) {
    	// Only works if glyphs are in increasing order
    ...
    public void setData(ByteBuffer data) {
        ...
        //Savelog.d(TAG, debug, "setData values: \n" + toString());
    }
    ...
    public String toString() {
        ...
        String indent = "    ";
        for (int i = 0; i < offsets.length; i++) {
        	buf.append(indent + "code " + i + ": " + " offset=" + offsets[i] + "\n");
        }
        return buf.toString();
    }
